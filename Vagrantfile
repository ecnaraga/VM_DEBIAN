...
machines=[
  {
    ...
    :cpus => "4",
    :script => "vm_init.sh",
    # :path_host_synced_folder => "synced_folder"
    # :path_VM_synced_folder => "/src"
  },
...
# # HERE VAGRANT FILE GENERATED BY CMD vagrant init: 
...
#   config.vm.provision "shell", path: "kfs_vm_init.sh"
